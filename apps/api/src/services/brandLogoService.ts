...
export function getBrandLogoSvg(brandName: string, accentColor: string = "#ffffff"): string {
  ...
  const logoFont = "'Noto Sans', 'DejaVu Sans', 'Liberation Sans', Arial, Helvetica, sans-serif";
  ...
  if (name.includes("maruti") || name.includes("suzuki")) {
    return `<svg viewBox="0 0 200 60" width="200" height="60" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="60" y="36" font-family="${logoFont}" font-size="16" font-weight="900" fill="${accentColor}" letter-spacing="1">MARUTI SUZUKI</text>
    </svg>`;
  }
  ...
  if (name.includes("hyundai")) {
    return `<svg viewBox="0 0 200 60" width="200" height="60" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="65" y="36" font-family="${logoFont}" font-size="18" font-weight="bold" fill="${accentColor}" letter-spacing="1.5">HYUNDAI</text>
    </svg>`;
  }
  ...
  if (name.includes("tata")) {
    return `<svg viewBox="0 0 200 60" width="200" height="60" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="65" y="37" font-family="${logoFont}" font-size="22" font-weight="900" fill="${accentColor}" letter-spacing="3">TATA</text>
    </svg>`;
  }
  ...
  if (name.includes("honda")) {
    return `<svg viewBox="0 0 200 60" width="200" height="60" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="65" y="37" font-family="${logoFont}" font-size="22" font-weight="bold" fill="${accentColor}" letter-spacing="2">HONDA</text>
    </svg>`;
  }
  ...
  if (name.includes("toyota")) {
    return `<svg viewBox="0 0 200 60" width="200" height="60" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="65" y="37" font-family="${logoFont}" font-size="20" font-weight="900" fill="${accentColor}" letter-spacing="2">TOYOTA</text>
    </svg>`;
  }
  ...
  if (name.includes("kia")) {
    return `<svg viewBox="0 0 200 60" width="200" height="60" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="95" y="36" font-family="${logoFont}" font-size="16" font-weight="900" fill="${accentColor}" letter-spacing="4">MOTORS</text>
    </svg>`;
  }
  ...
  if (name.includes("mahindra")) {
    return `<svg viewBox="0 0 200 60" width="200" height="60" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="58" y="37" font-family="${logoFont}" font-size="17" font-weight="900" fill="${accentColor}" letter-spacing="1.5">Mahindra</text>
    </svg>`;
  }
  ...
  return `<svg viewBox="0 0 200 60" width="200" height="60" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="25" y="35" font-family="${logoFont}" font-size="20" font-weight="bold" fill="${accentColor}" text-anchor="middle" dominant-baseline="middle">${uppercaseBrand[0] || 'C'}</text>
    <text x="60" y="36" font-family="${logoFont}" font-size="16" font-weight="bold" fill="${accentColor}" letter-spacing="1">${uppercaseBrand.slice(0, 12)}</text>
  </svg>`;
}
